...
levels(data.alpha$Treatment) <- factor(levels(data.alpha$Treatment), levels = c("Control", "Exposed"))
data.alpha$Treatment <- relevel(factor(data.alpha$Treatment), ref = "Control")
data.alpha$Treatment
...
ps.obj %>%
  ...
  ) + facet_wrap(. ~ Temperature + DPE + Treatment, scales = "free", ncol = 5) + 
...
ps.obj  %>% 
  ...
  comp_heatmap(
    ...
    sample_anno = sampleAnnotation(
      ...
      Treatment = anno_sample_cat(
        var = "Treatment", col = col.Treat, box_col = NA, border_col = "black",
...
ps.obj %>% 
  ...
  cor_heatmap(
    ...
    vars = c("Temperature", "DPE", "Treatment"), 
    tax_anno = taxAnnotation(
