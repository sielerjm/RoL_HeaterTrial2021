...
# Analysis ID
analysis.ID <- paste0(
  "ToL-HeaterTrial_",  # Data subsetted? If so, how? "<name>_"
...
save.image(paste0("~/Dropbox/Mac (2)/Documents/Sharpton_Lab/Projects_Repository/Rules_of_Life/RoL_HeaterTrial2021/Data/R_objects/RoL_HeaterTrial_PostMicroProc_ENV_", Sys.Date(),".RData"))
